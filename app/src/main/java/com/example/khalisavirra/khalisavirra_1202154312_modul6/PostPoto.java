...
public class PostPoto extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gambardiupload = (ImageView) findViewById(R.id.gambardiupload);
        title = (EditText) findViewById(R.id.bikinposttitle);
        caption = (EditText) findViewById(R.id.bikinpostcaption);
        store = FirebaseStorage.getInstance().getReference();
        dataref = FirebaseDatabase.getInstance().getReference().child("post");
        choose = (Button)findViewById(R.id.choose);

        //Listener ketika button choose diklik
    ...
    public void uploadingambar(View view) {
        ...
        task.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                dataref.push().setValue(user).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(PostPoto.this, "Post uploaded", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                    ...
                    public void onFailure(@NonNull Exception e) {
                        Toast.makeText(PostPoto.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            @Override
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(PostPoto.this, "Upload Failure!", Toast.LENGTH_SHORT).show();
                dlg.dismiss();
            }
        });
